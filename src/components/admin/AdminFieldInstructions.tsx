...
function ProductFields() {
  return (
    <>
      ...
      <FieldBlock title="Порядок на витрине">
        <p>
          Расстановка плиток при сортировке <strong>«По популярности»</strong> (по умолчанию на
          сайте): 1, 2, 3… — сверху вниз. У листов г/к из базы уже проставлены 1–8; меняйте это поле,
          а не «Размер (число)».
        </p>
      </FieldBlock>
      <FieldBlock title="Размер (число) *">
        <p>
          То же измерение, но <strong>числом</strong> — толщина/диаметр для «похожих товаров» и
          сортировки «По алфавиту» (на самом деле по этому числу).
        </p>
        <p>
